...
"[project]/src/app/(public)/tours/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$tours$2f$TourCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/tours/TourCard.tsx [app-client] (ecmascript)");
...
function ToursPage() {
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ToursPage.useMemo[filtered]": ()=>{
            let result = [
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tours"]
            ];
            if (query) result = result.filter({
                "ToursPage.useMemo[filtered]": (t)=>t.title.toLowerCase().includes(query.toLowerCase()) || t.location.toLowerCase().includes(query.toLowerCase())
            }["ToursPage.useMemo[filtered]"]);
            if (selectedCategories.length > 0) result = result.filter({
                "ToursPage.useMemo[filtered]": (t)=>selectedCategories.includes(t.category.toLowerCase())
            }["ToursPage.useMemo[filtered]"]);
            result = result.filter({
                "ToursPage.useMemo[filtered]": (t)=>t.price >= priceRange[0] && t.price <= priceRange[1]
            }["ToursPage.useMemo[filtered]"]);
            if (sortBy === "price-asc") result.sort({
                "ToursPage.useMemo[filtered]": (a, b)=>a.price - b.price
            }["ToursPage.useMemo[filtered]"]);
            else if (sortBy === "price-desc") result.sort({
                "ToursPage.useMemo[filtered]": (a, b)=>b.price - a.price
            }["ToursPage.useMemo[filtered]"]);
            else if (sortBy === "rating") result.sort({
                "ToursPage.useMemo[filtered]": (a, b)=>b.rating - a.rating
            }["ToursPage.useMemo[filtered]"]);
            return result;
        }
    }["ToursPage.useMemo[filtered]"], [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                                        ...
                                        children: filtered.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                            ...
                                            children: filtered.map((tour, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$tours$2f$TourCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                    tour: tour,
                                                    index: i
                                                }, tour.id, false, {
                                                    fileName: "[project]/src/app/(public)/tours/page.tsx",
...
_s(ToursPage, "7nWZYqbMl46xLAQ3JqbY0mau8Co=");
_c = ToursPage;
var _c;
...
//# sourceMappingURL=src_5660a60a._.js.map