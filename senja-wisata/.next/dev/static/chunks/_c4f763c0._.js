...
const initialBookings = [
    ...
    },
    {
        ...
        tour: "Lombok & Gili Islands",
        date: "2025-02-25",
        guests: 2,
        total: 9600000,
        status: "cancelled",
        payment_status: "refunded",
        refund_amount: 8640000,
        refund_percentage: 90,
        created: "2025-02-08"
    },
    {
        id: "BK-2025-042",
        user: "Linda Handayani",
        email: "linda@mail.com",
        phone: "+62 812-0006-0006",
        tour: "Yogyakarta Cultural Tour",
        date: "2025-02-20",
        guests: 4,
        total: 9600000,
        status: "completed",
...
function AdminBookingsPage() {
    ...
    const [detailBooking, setDetailBooking] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminBookingsPage.useEffect": ()=>{
            fetch("/api/booking/all").then({
                "AdminBookingsPage.useEffect": (r)=>r.json()
            }["AdminBookingsPage.useEffect"]).then({
                "AdminBookingsPage.useEffect": (data)=>{
                    if (data.bookings && data.bookings.length > 0) {
                        const realBookings = data.bookings.map({
                            "AdminBookingsPage.useEffect.realBookings": (b)=>({
                                    id: b.booking_code || String(b.id),
                                    user: b.user_name || "Guest",
                                    email: b.user_email || "",
                                    tour: b.tour_title || "",
                                    date: b.tour_date || "",
                        ...
                        }["AdminBookingsPage.useEffect.realBookings"]);
                        // Merge: real bookings first, then dummy ones not already present
                        const realIds = new Set(realBookings.map({
                            "AdminBookingsPage.useEffect": (b)=>b.id
                        }["AdminBookingsPage.useEffect"]));
                        const merged = [
                            ...realBookings,
                            ...initialBookings.filter({
                                "AdminBookingsPage.useEffect": (b)=>!realIds.has(b.id)
                            }["AdminBookingsPage.useEffect"])
                        ];
                        setBookings(merged);
                    }
                }
            }["AdminBookingsPage.useEffect"]).catch({
                "AdminBookingsPage.useEffect": ()=>{}
            }["AdminBookingsPage.useEffect"]);
        }
    }["AdminBookingsPage.useEffect"], []);
    const filtered = bookings.filter((b)=>{
        ...
        const matchSearch = b.user.toLowerCase().includes(search.toLowerCase()) || b.id.toLowerCase().includes(search.toLowerCase()) || b.tour.toLowerCase().includes(search.toLowerCase());
        return matchTab && matchSearch;
    });
    const countByStatus = (s)=>s === "Semua" ? bookings.length : bookings.filter((b)=>b.status === s).length;
    const updateStatus = async (id, status)=>{
        ...
        showToast(status === "confirmed" ? "Booking berhasil dikonfirmasi!" : status === "completed" ? "Booking ditandai selesai!" : status === "cancelled" ? "Booking dibatalkan." : "Status diperbarui.");
    };
    const showToast = (msg)=>{
        setSuccessMsg(msg);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            successMsg && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed top-6 right-6 z-50 bg-emerald-500 text-white px-5 py-3 rounded-xl shadow-xl font-semibold text-sm flex items-center gap-2",
                children: [
                    "✓ ",
                    successMsg
                ]
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "card p-2 flex gap-1 overflow-x-auto",
                children: statusTabs.map((tab)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: `text-xs px-1.5 py-0.5 rounded-full font-bold ${activeTab === tab ? "bg-white/20 text-white" : "bg-slate-100 text-slate-500"}`,
                                children: countByStatus(tab)
                            }, void 0, false, {
                                fileName: "[project]/src/app/admin/bookings/page.tsx",
                                lineNumber: 125,
                                columnNumber: 25
                                ...
                                children: filtered.map((b, i)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "p-4 hidden lg:table-cell text-slate-500 max-w-[160px] truncate",
                                                children: b.tour
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                lineNumber: 168,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "p-4 hidden sm:table-cell text-slate-500",
                                                children: b.date
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                lineNumber: 169,
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                ...
                                                children: [
                                                    b.payment_status && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: `badge text-xs w-fit ${b.payment_status === "paid" ? "bg-emerald-50 text-emerald-600" : b.payment_status === "refunded" ? "bg-purple-50 text-purple-600" : b.payment_status === "pending" ? "badge-warning" : "bg-red-50 text-red-500"}`,
                                                        children: {
                                                            paid: "💳 Lunas",
                                                            pending: "⏳ Belum Bayar",
                                                            refunded: "↩ Refund",
                                                    ...
                                                    b.payment_status === "refunded" && b.refund_amount != null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "text-xs text-purple-500 mt-0.5",
                                                        children: [
                                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPrice"])(b.refund_amount),
                                                            " (",
                                                            b.refund_percentage,
                                                            "%)"
                                                        ]
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: `badge flex items-center gap-1 w-fit ${s.cls}`,
                                                    children: [
                                                        s.icon,
                                                        " ",
                                                        s.label
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        b.status === "pending" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    ...
                                                                    className: "btn btn-sm text-xs bg-emerald-500 text-white border-emerald-500 hover:bg-emerald-600",
                                                                    children: "Konfirmasi"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                                    lineNumber: 199,
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    ...
                                                                    className: "btn btn-sm text-xs bg-red-50 text-red-500 border-red-200 hover:bg-red-100",
                                                                    children: "Tolak"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                                    lineNumber: 201,
                                                        ...
                                                        b.status === "confirmed" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            ...
                                                            className: "btn btn-sm text-xs gap-1 text-white border-0",
                                                            style: {
                                                                backgroundColor: '#05073C'
                                                            },
                                                            children: [
                    ...
                    filtered.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Tidak ada booking ditemukan"
                            }, void 0, false, {
                                fileName: "[project]/src/app/admin/bookings/page.tsx",
                                lineNumber: 221,
                                columnNumber: 25
            ...
            detailBooking && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: detailBooking.email
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                    lineNumber: 246,
                                                    columnNumber: 37
                                                }, this),
                                                detailBooking.phone && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-xs text-slate-500",
                                                    children: detailBooking.phone
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                    lineNumber: 247,
                                                    columnNumber: 61
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPrice"])(detailBooking.total)
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                    lineNumber: 265,
                                                    columnNumber: 37
                                                }, this),
                                                detailBooking.payment_status && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: `badge text-xs mt-1 ${detailBooking.payment_status === "paid" ? "bg-emerald-50 text-emerald-600" : detailBooking.payment_status === "refunded" ? "bg-purple-50 text-purple-600" : detailBooking.payment_status === "pending" ? "badge-warning" : "bg-red-50 text-red-500"}`,
                                                    children: {
                                                        paid: "💳 Lunas",
                                                        pending: "⏳ Belum Bayar",
                                                        refunded: "↩ Refund",
                                                        cancelled: "✕ Batal",
                                                        expired: "⌛ Expired"
                                                    }[detailBooking.payment_status] || detailBooking.payment_status
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/admin/bookings/page.tsx",
                                                    lineNumber: 267,
                                                    columnNumber: 41
                                                }, this),
                                                detailBooking.payment_status === "refunded" && detailBooking.refund_amount != null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "text-xs text-purple-600 mt-1",
                                                    children: [
                                                        "Refund: ",
                                                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPrice"])(detailBooking.refund_amount),
                                                        " (",
                                                        detailBooking.refund_percentage,
                                                        "%)"
                                                    ]
                                                }, void 0, true, {
                                                    fileName: "[project]/src/app/admin/bookings/page.tsx",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: `badge flex items-center gap-1 ${statusMap[detailBooking.status].cls}`,
                                            children: [
                                                statusMap[detailBooking.status].icon,
                                                " ",
                                                statusMap[detailBooking.status].label
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/admin/bookings/page.tsx",
                                            lineNumber: 279,
                                ...
                                detailBooking.status === "pending" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                detailBooking.status === "confirmed" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(AdminBookingsPage, "zOEhmvMpy2aOKlPD7ZKg/8gUa08=");
...
//# sourceMappingURL=_c4f763c0._.js.map