...
function AdminLayout({ children }) {
    ...
    const fetchChatBadge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminLayout.useCallback[fetchChatBadge]": async ()=>{
            try {
                const res = await fetch("/api/chat/session");
                const data = await res.json();
                const slist = data.sessions ?? [];
                setTotalUnread(slist.reduce({
                    "AdminLayout.useCallback[fetchChatBadge]": (a, s)=>a + s.unread_by_admin
                }["AdminLayout.useCallback[fetchChatBadge]"], 0));
                setWaitingCount(slist.filter({
                    "AdminLayout.useCallback[fetchChatBadge]": (s)=>s.status === "waiting"
                }["AdminLayout.useCallback[fetchChatBadge]"]).length);
            } catch  {}
        }
    }["AdminLayout.useCallback[fetchChatBadge]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminLayout.useEffect": ()=>{
            fetchChatBadge();
            const t = setInterval(fetchChatBadge, 30_000);
            return ({
                "AdminLayout.useEffect": ()=>clearInterval(t)
            })["AdminLayout.useEffect"];
        }
    }["AdminLayout.useEffect"], [
        fetchChatBadge
...
_s(AdminLayout, "MO/L3etL+XLd/U+/8cto618mgJc=", false, function() {
    return [
...
//# sourceMappingURL=src_f154648a._.js.map