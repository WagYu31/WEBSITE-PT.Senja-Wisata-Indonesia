...
async function POST(req) {
    try {
        ...
        try {
            ...
            // DB might not exist in dev — that's okay, we still return the snap token
            console.warn("[Booking] DB insert skipped (table might not exist in dev)");
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            bookingCode,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc00f10e._.js.map