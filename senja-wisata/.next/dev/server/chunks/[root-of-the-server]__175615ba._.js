...
"[project]/src/app/api/booking/snap-token/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!bookingCode) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "bookingCode diperlukan"
    }, {
        status: 400
    });
    // Try in-memory store first
    const memBooking = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bookingStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bookingStore"].getByCode(bookingCode);
    if (memBooking?.snap_token) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            snapToken: memBooking.snap_token
        });
    }
    // Try DB
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query("SELECT snap_token FROM bookings WHERE booking_code = ?", [
            bookingCode
        ]);
        if (rows[0]?.snap_token) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                snapToken: rows[0].snap_token
            });
        }
    } catch  {}
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Snap token tidak ditemukan"
    }, {
        status: 404
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__175615ba._.js.map