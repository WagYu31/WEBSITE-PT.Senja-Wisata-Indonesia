...
"[project]/src/app/api/ticket/[code]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    if (!code) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Kode booking diperlukan"
    }, {
        status: 400
    });
    try {
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].query(`SELECT b.booking_code, b.tour_date, b.guests, b.adults, b.children, 
        ...
        if (!rows[0]) {
            ...
            if (mockBooking) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                booking: mockBooking
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de9f0caa._.js.map